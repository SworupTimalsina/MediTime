...
const Doctors = () => {
    ...
    return (
        <div>
            <p className='text-gray-800'>Browse through the docotors specialist.</p>
            ...
            <div className='w-full grid grid-cols-auto gap-4 gap-y-6'>
                {
                    ...
                    <div onClick={()=> navigate(`/appointment/${item._id}`)}className='border border-blue-200 rounde-x1 overflow-hidden cursor-pointer hover:translate-y-[-10px] transaction all duration-500'key={index}>
